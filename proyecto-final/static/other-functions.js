function addSet(currentEx, currentSet){
    ...
    document.getElementById('ex-' + currentEx).insertAdjacentHTML('beforeend', '<div id="ex-'+ currentEx +'-set-'+ newSet +'">'
        ...
        + '</div>'
        + '<div class="col">'
        + '<input type="number" autocomplete="off" autofocus placeholder="Weight in KG" class="form-control">'
        + '</div>'
        + '<div class="col">'
        + '<input type="number" autocomplete="off" autofocus placeholder="Reps" class="form-control">'
        + '</div>'
        + '</div>'
        + '</div>'
    )
